import numpy as np
import time #used to count time taken for execution

numGDiter = 0 #used to calculate number of time we move against the gradient(gradient descent iterations)
numBHiter = 0 #used to calculate number of basin-hopping iterations
...
print("Number of Basin-Hopping iterations = ",numBHiter)
print("Number of Gradient Descent iterations = ",numGDiter)